            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Den of Art </h1>
                                    ...
                                    <form action="update_edit.php" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <input type="text" name="datetime" class="form-control form-control-user" placeholder="วัน/เดือน/ปี" value="<?php echo $row['day']; ?>">
                                            </div>
                                            <div class="col-md-6 col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <label for="">ค่ารักษา</label>
                                                <input type="text" name="amount" class="form-control form-control-user" placeholder="ค่ารักษา" value="<?php echo $row['amount']; ?>">
                                            </div>

                                        </div>
                                        <div class="col-12 hide-prith text-center pt-5">

                                        <input onclick="javascript:window.print()" type="button" class="hide-prith" class="text-center" value="คลิ๊กเพื่อ Print หน้านี้" name="print2">
