            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">เพิ่มด้านการรักษา</h1>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4 ">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="inset_date.php" method="POST">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-lg-8">
                                                <label for="">ลายละเอียดการนัดหมาย</label>
                                                <input type="text" name="detel" class="form-control form-control-user" placeholder="" value="">
                                            </div>
