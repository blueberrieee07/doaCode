...
<head>
    ...
    <title>SB Admin 2 - ไปหน้าหลัก55555</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">pornphipat</span>
                                <img class="img-profile rounded-circle"
                                    src="https://cdn.tigthai.com/imguploads/201904/23/03449870015560083658220_Doraemon_1.jpg">
                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">65,000.-</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ยอดค้างชำระ</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">25,645.-</div>
                                        </div>
                                        <div class="col-auto">
